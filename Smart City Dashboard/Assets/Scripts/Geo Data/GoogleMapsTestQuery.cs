...
public class GoogleMapsTestQuery: MonoBehaviour
{
    ...
    private static string CreateQuery(int size, int zoom, string location, string apiKey)
    {
        ...
        stringBuilder.Append("&style=feature:landscape|color:0x000000&style=element:labels|visibility:off&style=feature:road|color:0x880000&style=feature:road.local|geometry|color:0x008800&style=feature:road|weight:2&style=feature:road|element:labels|visibility:off&style=feature:poi|element:labels|visibility:off&style=feature:poi|visibility:off&style=feature:transit|visibility:off&style=feature:water|visibility:off&style=feature:administrative|visibility:off&key=");
